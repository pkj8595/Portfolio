...
void TextSystemManager::shopLog(wstring itemName, wstring price)
{
	...
	FONTMANAGER->drawText(getMemDC(), WINSIZE_X*0.14, WINSIZE_Y*0.78, "맑은 고딕", 27, 15,
...
void TextSystemManager::EventLog(int arrText)
{
	...
	FONTMANAGER->drawText(getMemDC(), WINSIZE_X*0.1, WINSIZE_Y*0.78, "맑은 고딕", 27, 15, _text[arrText].script, 
